...
label_style.configure("Bold.TLabel", font=("Helvetica", 14, "bold"), foreground="#333333", background="#ffffff")
...
entry_style.configure("Custom.TEntry", font=("Helvetica", 12), foreground="#333333", background="#f5f5f5", bordercolor="#d9d9d9", relief="flat")
