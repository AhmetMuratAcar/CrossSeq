...
window.configure(bg="#283149")

# Create a style for the labels
label_style = ttk.Style()
label_style.configure("Bold.TLabel", font=("Verdana", 10, "bold"), foreground="#FFF", background="#283149")

# Create a label for the header
header_label = ttk.Label(text="Enter FASTA Sequences", style="Bold.TLabel")
header_label.grid(column=0, row=0, padx=10, pady=20, columnspan=2)

# Create a style for the entry fields
entry_style = ttk.Style()
entry_style.configure("Custom.TEntry", font=("Verdana", 10), foreground="#283149")
...
entry1.grid(column=1, row=1, padx=10, pady=10)
...
entry2.grid(column=1, row=2, padx=10, pady=10)
...
button_style.configure("Submit.TButton", font=("Verdana", 10), background="#45A29E", foreground="#FFF")
...
submit_button.grid(column=1, row=3, padx=10, pady=20)
